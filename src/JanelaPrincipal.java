...
public class JanelaPrincipal extends JFrame {
    ...
    public void reagir(CasaGUI casaClicada) {
        if (primeiroClique) {
            ...
            primeiroClique = true;
            atualizar();
            if(jogo.chequemate(jogo.turno)){
                if(jogo.turno == 1){
                    JOptionPane.showMessageDialog(this, "As pretas ganharam!");
                }
                else { 
                    JOptionPane.showMessageDialog(this, "As brancas ganharam!");
                }
            }
            else if(jogo.reiAfogado(jogo.turno)) JOptionPane.showMessageDialog(this, "Empate...");
            else if(jogo.empatePorMaterial()) JOptionPane.showMessageDialog(this, "Empate por falta de material!");
        }
    }
